...
\pause \item The last changed repository items lead to a
 new \COii\ emission factors vector
\maindm{
...
\item The Li driving batteries are expensive to produce and there is
  ...
  $C_{15}$\\[1ex]
\pause \item The energy emission factor is based, e.g., on the present (2023)
  German energy mix emitting \unit[400]{g} \COii\ per kWh of electrical
...
\unit[20]{kWh} * \unit[0.4]{kg/kWh}=\unit[8]{kg}. The ICV vehicle
emits directly and indirectly
\unit[6]{l} * \unit[2.7]{kg/l}=\unit[16.2]{kg}. So, the BEV \COii
emissions per kilometer are about half that of the ICE
