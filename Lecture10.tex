...
\section{10 \  Advanced Concepts of Discrete-Choice Theory}
...
10 \ Advanced Concepts of\\ \hspace*{1em} Discrete-Choice Theory
}}}

\placebox{0.40}{0.30}{\parbox{0.8\textwidth}{
{\large
\bi
\item 10.1 Parameter Nonlinear Models
\item 10.2 GEV and Nested Logit Models
\bi
\item 10.2.1 General Specification
\item 10.2.2 Nested Logit Model
\item 10.2.3 Example: Combined Destination and Mode Choice
\ei
%\item 10.3 Mixed-Logit Models (German script)
%\item 10.4 Models for Reliability (German script)
\ei
}
}}
...
\subsection{10.1 Parameter Nonlinear Models}

%##############################################################
\frame{\frametitle{10.1  \EinsteinPdflatex Parameter Nonlinear Models}
%##############################################################
...
\subsection{10.2 GEV and Nested Logit Models}

%##############################################################
\frame{\frametitle{10.2 GEV and Nested Logit Models}
%##############################################################
\textbf{Motivation}
...
\subsubsection{10.2.3 Example: Combined Destination and Mode Choice}

% from ~/vorlesungen/Verkehrsoekonometrie_Ma/discrChoice_cc_Levmar/
% = \pathDiscrChoic

%##############################################################
\frame{\frametitle{10.2.3 Example: Combined Destination and Mode Choice}
%##############################################################
...
\subsection{10.3 Mixed-Logit models}

%##############################################################
\frame{\frametitle{10.3 Mixed-Logit models}
%##############################################################
...
\subsection{10.4 Models for Reliability}

%##############################################################
\frame{\frametitle{10.4  Models for Reliability}
%##############################################################
